-- MySQL Migration 009: Hearing Logging System (phpMyAdmin Compatible Version)
-- Use this version if you're running the migration in phpMyAdmin
-- This file contains the trigger definitions without DELIMITER syntax
...
-- ============================================
-- TRIGGERS (Run these separately in phpMyAdmin)
-- ============================================
-- Note: In phpMyAdmin, you may need to run each trigger separately
-- or use the "Routines" tab to create them
...
-- Trigger for INSERT (run this first)
-- Change delimiter in phpMyAdmin settings or run via command line
...
-- Trigger for UPDATE (run this second)
